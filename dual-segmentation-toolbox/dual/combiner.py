...
class Combiner:
    ...
    def init_all_parameters(self):
        self.div_epoch = self.max_epoch_number
    ...
    def forward(self, image, label, meta):
        return self.dual_forward(image, label, meta)
    ...
    def dual_forward(self, image, label, sample_image, sample_label, stages=1):
